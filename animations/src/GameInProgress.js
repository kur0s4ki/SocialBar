    ...
    <div className="min-h-screen bg-slate-900 px-8 py-2 font-sans flex items-center justify-center">
      <div className="max-w-[90vw] w-full space-y-12">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1 bg-slate-900 border-4 border-cyan-400 rounded-2xl p-10">
          ...
          <div className="bg-slate-900 border-4 border-cyan-400 rounded-2xl p-10 flex items-center justify-center min-w-[250px]">
            <span className="text-yellow-400 text-9xl font-bold">4270</span>
          </div>
        </div>

        {/* Mission Section */}
        <div className="bg-slate-900 border-4 border-cyan-400 rounded-2xl p-16 relative min-h-[35vh] flex items-center justify-center">
          {/* Mission Badge */}
          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2">
            <div className="bg-slate-900 border-4 border-yellow-400 rounded-2xl px-16 py-6">
        ...
        <div className="grid grid-cols-3 gap-8">
          {/* Multiplier */}
          <div className="bg-slate-900 border-4 border-cyan-400 rounded-2xl p-12 flex items-center justify-center">
            <span className="text-yellow-400 text-8xl font-bold">x2</span>
          </div>

          {/* Bonus Central */}
          <div className="bg-slate-900 border-4 border-cyan-400 rounded-2xl p-12 flex flex-col items-center justify-center space-y-4">
          ...
          {/* Buttons */}
          <div className="bg-slate-900 border-4 border-cyan-400 rounded-2xl p-12 flex flex-col items-center justify-center space-y-5">
